...
class Brains():
    ...
    def plot_graphs(self):
        ...
        self.random_multiple.plot_multiple_graphs(*dict2, xlims=(-200, 400), ylims=(0, 1), labels=[f"steps = {i}" for i in list_steps])
        self.decay_static.plot_multiple_graphs(*dict3, xlims=(-0.0025, 0.0025), ylims=(0, 1), marker="None", ls="-", labels=[f"t = {tval*1e6:.1f}$\mu$s" for tval in self.random.tlist])
