...
class Plotter():
    def _init_(self, x, y, func: int, xlabel: str, ylabel: str, figname: str):
        ...
        self.fig.set_xlabel(self.xlabel)        #adding xlabel to figure
        self.fig.set_ylabel(self.ylabel)        #adding ylabel to figure
    ...
    def plot_best_fit(self):
        ...
        self.fig.tight_layout()
        self.fig.savefig(f"{self.filename}.pdf", dpi=350)